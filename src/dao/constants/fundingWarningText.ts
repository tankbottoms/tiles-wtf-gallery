...
export const FUNDING_CYCLE_WARNING_TEXT: () => {
	...
	return {
		duration: `The project owner may reconfigure this funding cycle at any time, without notice.`,
		ballot: `Funding cycles can be reconfigured moments before a new cycle begins, without notifying contributors.`,
		allowMinting: `The project owner may mint any supply of tokens at any time, diluting the token share of all existing contributors.`,
		metadataMaxReservedRate: `Contributors will not receive any tokens in exchange for paying this project.`,
		metadataReservedRate: `Contributors will receive a relatively small portion of tokens in exchange for paying this project.`
	};
};
