export default {
	address: '0x4b9f876c7Fc5f6DEF8991fDe639b2C812a85Fb12',
	abi: [
		{
			inputs: [
				{
	...
	transactionHash: '0xb2a63b80127a2d7a23a5276588a255d10f4005c4d8e8c329d44afc417b686e11',
	receipt: {
		to: null,
		from: '0xE9bE6df23C7f9CaBa3005DA2fa2d8714d340D0aF',
		contractAddress: '0x4b9f876c7Fc5f6DEF8991fDe639b2C812a85Fb12',
		transactionIndex: 34,
		gasUsed: '455444',
		logsBloom:
			'',
		blockHash: '0xbafd061164387ed722bc46e7788085d50d5e6fa9b5dc0e512f311c08c3457024',
		transactionHash: '0xb2a63b80127a2d7a23a5276588a255d10f4005c4d8e8c329d44afc417b686e11',
		logs: [],
		blockNumber: 14868845,
		cumulativeGasUsed: '3121236',
		status: 1,
		byzantium: true
	},
	args: [259200, '0x6B8e01DAA8A61b544F96d2738893E05D04BF1D12'],
	numDeployments: 3,
		...
		storage: [
			{
				...
				offset: 0,
				slot: '0',
				type: 't_mapping(t_uint256,t_mapping(t_uint256,t_enum(JBBallotState)16904))'
			}
		],
		types: {
			't_enum(JBBallotState)16904': {
				encoding: 'inplace',
				label: 'enum JBBallotState',
				numberOfBytes: '1'
			},
			't_mapping(t_uint256,t_enum(JBBallotState)16904)': {
				encoding: 'mapping',
				key: 't_uint256',
				label: 'mapping(uint256 => enum JBBallotState)',
				numberOfBytes: '32',
				value: 't_enum(JBBallotState)16904'
			},
			't_mapping(t_uint256,t_mapping(t_uint256,t_enum(JBBallotState)16904))': {
				encoding: 'mapping',
				key: 't_uint256',
				label: 'mapping(uint256 => mapping(uint256 => enum JBBallotState))',
				numberOfBytes: '32',
				value: 't_mapping(t_uint256,t_enum(JBBallotState)16904)'
			},
			t_uint256: {
				encoding: 'inplace',
				label: 'uint256',
