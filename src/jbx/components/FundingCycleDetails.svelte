<script lang="ts">
	...
	// TODO move
	import CollapsibleSection from '$jbx/create/CollapsibleSection.svelte';
	...
	import { detailedTimeUntil } from '$jbx/utils/formatTime';
	...
	import { getFundingCycleDetails, V2FundingCycleRiskCount } from '$jbx/utils/v2/fundingCycle';
