export default {
  "address": "0x9733F02d3A1068A11B07516fa2f3C3BaEf90e7eF",
  "abi": [
    {
      "inputs": [
        {
  ...
  "transactionHash": "0xa13126cc6f5b6adbc1d0dac7cc66e8fe466970ea97c6b93185ba1e588ff16394",
  "receipt": {
    "to": null,
    "from": "0xE9bE6df23C7f9CaBa3005DA2fa2d8714d340D0aF",
    "contractAddress": "0x9733F02d3A1068A11B07516fa2f3C3BaEf90e7eF",
    "transactionIndex": 23,
    "gasUsed": "455444",
    "logsBloom": "",
    "blockHash": "0xc95090e67a91e544b184edeb9e7eedabbe426ba49488968d8ee77d1ded864455",
    "transactionHash": "0xa13126cc6f5b6adbc1d0dac7cc66e8fe466970ea97c6b93185ba1e588ff16394",
    "logs": [],
    "blockNumber": 14730697,
    "cumulativeGasUsed": "1577441",
    "status": 1,
    "byzantium": true
  },
  "args": [259200, "0xb056BE159605c626D3e9aCa5DE466FFfa475758c"],
  "numDeployments": 1,
    ...
    "storage": [
      {
        ...
        "offset": 0,
        "slot": "0",
        "type": "t_mapping(t_uint256,t_mapping(t_uint256,t_enum(JBBallotState)16770))"
      }
    ],
    "types": {
      "t_enum(JBBallotState)16770": {
        "encoding": "inplace",
        "label": "enum JBBallotState",
        "numberOfBytes": "1"
      },
      "t_mapping(t_uint256,t_enum(JBBallotState)16770)": {
        "encoding": "mapping",
        "key": "t_uint256",
        "label": "mapping(uint256 => enum JBBallotState)",
        "numberOfBytes": "32",
        "value": "t_enum(JBBallotState)16770"
      },
      "t_mapping(t_uint256,t_mapping(t_uint256,t_enum(JBBallotState)16770))": {
        "encoding": "mapping",
        "key": "t_uint256",
        "label": "mapping(uint256 => mapping(uint256 => enum JBBallotState))",
        "numberOfBytes": "32",
        "value": "t_mapping(t_uint256,t_enum(JBBallotState)16770)"
      },
      "t_uint256": {
        "encoding": "inplace",
        "label": "uint256",
