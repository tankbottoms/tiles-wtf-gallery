export default {
  "address": "0xCAEC2DF60aBEfC165ABF8241ddc6e8D0E91eAb24",
  "abi": [
    {
      "inputs": [
        {
  ...
  "transactionHash": "0x9710c2588f35ec673f1058d74a0c4153ae4877bfccf76b2bcfe5da8cf0b5f3d9",
  "receipt": {
    "to": null,
    "from": "0xE9bE6df23C7f9CaBa3005DA2fa2d8714d340D0aF",
    "contractAddress": "0xCAEC2DF60aBEfC165ABF8241ddc6e8D0E91eAb24",
    "transactionIndex": 0,
    "gasUsed": "1600719",
    "logsBloom": "",
    "blockHash": "0xd54324780442d6995a51c802bc6fecef1e01762a4b06e66d06fb5c898894429f",
    "transactionHash": "0x9710c2588f35ec673f1058d74a0c4153ae4877bfccf76b2bcfe5da8cf0b5f3d9",
    "logs": [
      {
        "transactionIndex": 0,
        "blockNumber": 10635484,
        "transactionHash": "0x9710c2588f35ec673f1058d74a0c4153ae4877bfccf76b2bcfe5da8cf0b5f3d9",
        "address": "0xCAEC2DF60aBEfC165ABF8241ddc6e8D0E91eAb24",
        "topics": [
  ...
  "storageLayout": {
    "storage": [
      ...
      },
      {
        ...
        "offset": 0,
        "slot": "1",
        "type": "t_mapping(t_uint256,t_array(t_contract(IJBPaymentTerminal)17820)dyn_storage)"
      },
      {
        "astId": 6433,
        "contract": "contracts/JBDirectory.sol:JBDirectory",
        ...
        "offset": 0,
        "slot": "2",
        "type": "t_mapping(t_uint256,t_mapping(t_address,t_contract(IJBPaymentTerminal)17820))"
      },
      {
        "astId": 6449,
        "contract": "contracts/JBDirectory.sol:JBDirectory",
    ...
    "types": {
      ...
      "t_array(t_contract(IJBPaymentTerminal)17820)dyn_storage": {
        "base": "t_contract(IJBPaymentTerminal)17820",
      ...
      "t_mapping(t_address,t_contract(IJBPaymentTerminal)17820)": {
        "encoding": "mapping",
        "key": "t_address",
        "label": "mapping(address => contract IJBPaymentTerminal)",
        "numberOfBytes": "32",
        "value": "t_contract(IJBPaymentTerminal)17820"
      },
      ...
      "t_mapping(t_uint256,t_array(t_contract(IJBPaymentTerminal)17820)dyn_storage)": {
        "encoding": "mapping",
        "key": "t_uint256",
        "label": "mapping(uint256 => contract IJBPaymentTerminal[])",
        "numberOfBytes": "32",
        "value": "t_array(t_contract(IJBPaymentTerminal)17820)dyn_storage"
      },
      "t_mapping(t_uint256,t_mapping(t_address,t_contract(IJBPaymentTerminal)17820))": {
        "encoding": "mapping",
        "key": "t_uint256",
        "label": "mapping(uint256 => mapping(address => contract IJBPaymentTerminal))",
        "numberOfBytes": "32",
        "value": "t_mapping(t_address,t_contract(IJBPaymentTerminal)17820)"
      },
      "t_uint256": {
        "encoding": "inplace",
        "label": "uint256",
