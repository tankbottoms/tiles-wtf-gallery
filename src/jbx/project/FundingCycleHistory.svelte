<script lang="ts">
	...
	import type { V2FundingCycle } from '$jbx/models/v2/fundingCycle';
	import { V2CurrencyName } from '$jbx/utils/v2/currency';
	import { formatDiscountRate, MAX_DISTRIBUTION_LIMIT } from '$jbx/utils/v2/math';
