import { firestore, getDocuments } from '$jbx/stores/firebase';
import type { ProfileDataResponse } from '$jbx/twitter-auth/api/get-profile-data';
...
import { connectedAccount } from '$jbx/stores/web3';
