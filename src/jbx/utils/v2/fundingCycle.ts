...
} from '$jbx/constants/fundingWarningText';
import type {
	V2FundingCycle,
...
import { formattedNum, formatWad } from '$jbx/utils/formatNumber';
import { detailedTimeString } from '$jbx/utils/formatTime';
import {
	formatDiscountRate,
...
import { invertPermyriad } from '$jbx/utils/bigNumbers';
import unsafeFundingCycleProperties from '$jbx/utils/unsafeFundingCycleProperties';
...
import type { FundingCycleRiskFlags } from '$jbx/constants/fundingWarningText';
