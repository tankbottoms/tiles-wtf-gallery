<section>
	...
	<p>
		implement the tile's visual rendering algorithm to be completely on chain. reset and slow the nft cost. 
		open source a fully operational self-hosted svelte <a href="https://juicebox.money/v2/p/41" target="_blank">juicebox treasury</a
		>.  
	</p>
	<b>how will the tiles v2 proceeds be used?</b>
	...
	<p>
		initialization parameters were set in the <a
			href="https://github.com/tankbottoms/tiles-on-chain/blob/main/scripts/mainnet.ts"
			target="_blank">deploy script</a
		>, the tiles has what is called the
		<a
			href="https://github.com/tankbottoms/tiles-on-chain/blob/main/contracts/LegacyOwnershipPriceResolver.sol"
			>LegacyOwnershipPriceResolver</a
		>
		which governs how pricing is resolved. if a tile for which the address owner discovers is
	...
	<p>
		no juicebox treasury, no source code; 
		activities which are competitive to tankbottoms and his affilates are prohibited. 		
	</p>
</section>
