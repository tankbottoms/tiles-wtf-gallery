...
<SplitPane>
	...
	<section slot="right">
		...
		<p>Contracts: Rinkeby InfiniteTiles.sol <a href="https://rinkeby.etherscan.io/address/{APP_CONFIG.contract_rinkeby}#code" target="_blank">{getTruncatedAddress(APP_CONFIG.contract_rinkeby)}</a>, Mainnet TilesContentProvider.sol <a href="https://etherscan.io/address/{APP_CONFIG.contract_tiles_content_provider}#code" target="_blank">{getTruncatedAddress(APP_CONFIG.contract_tiles_content_provider)}</a>, InfiniteTiles.sol <a href="https://etherscan.io/address/{APP_CONFIG.contract_mainnet}#code" target="_blank">{getTruncatedAddress(APP_CONFIG.contract_mainnet)}</a></p>
		<p>Opensea: <a href="https://opensea.io/collection/infinite-tiles-v2" target="_blank">Inifinite Tiles v2</a>, Looksrare: <a href="https://looksrare.org/collections/{APP_CONFIG.contract_mainnet}" target="_blank">{getTruncatedAddress(APP_CONFIG.contract_mainnet)}</a></p>
		<!--							
