...
<SplitPane>
	...
	<section slot="right">
		...
		<p>
			All proceeds will be transparently managed on <a href="/dao">Juicebox</a>.
			...
			>
			will recieve the
			<a href="https://juicebox.money/v2/p/175" target="_blank">Juicebox Project NFT</a>. The
			initial signers are listed in
			<a href="/wtf">wtf,</a> while membership to the DAO is offered to anyone who holds Tiles2 NFT or
			the project ERC-20, the specifics of governance, if any, has not been decided. There may be no
		...
		<p>
			...
			<a
				...
				>here</a
			>. You can use Tiles to token-gate IRL using
			<a href="https://gatekeep.it/" target="_blank">Gatekeeper</a>.
		</p>
		<p>
			Tiles can be used on your site for a profile picture or just decorative imagery for contracts,
			for example, the animations <a href="/render/ethereal/{randomAddresses[0]}" target="_blank"
				>ethereal</a
