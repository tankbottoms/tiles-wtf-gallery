<section>
	...
	<h1>WTF?</h1>
	<p>
		<a href="https://github.com/tankbottoms/tiles-on-chain">Tiles v1.2 (on-chain)</a>, as the name suggests, is an on-chain re-implementation of <a href="https://twitter.com/peripheralist"
			...
			>@peripheralist, the genius artist, developer, person</a>.
	</p>			
	<p>
