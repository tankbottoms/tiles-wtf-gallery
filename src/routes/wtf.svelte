<section>
	...
	<h1>wtf?</h1>
	<p>
		og <a href="https://tiles.art">tiles</a> owners mint for free. in the entertaining event that someone
		has minted your addresses' tile, you may repossess the tile by minting it anew (affectionately referred
		to as "seizing").
	</p>
	<p>
		<b>
