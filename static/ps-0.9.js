		...
		(b.$canv.onmousedown = function () {
			if (b.imgs.length > 1) {
				...
				b.mx >= 0 && b.mx < b.arrowPadding * 2 + b.$prevCanv.width
					? (a = -1)
					: b.mx > 0 && b.mx > b.cw - (b.arrowPadding * 2 + b.$nextCanv.width) && (a = 1),
					(b.mouseDownRegion = a);
			}
		}),
...
(psParticle.prototype.move = function () {
	...
	if (this.ttl != null && this.ttl-- <= 0)
		...
		a.restless == !0
			...
			: g < 0.01 && ((this.x = this.gravityX + 0.25), (this.y = this.gravityY + 0.25));
		var h = 0,
			i = 0;
	...
	(ParticleSlider.prototype.$ = function (a, b, c) {
		...
		if (a[0] == '.') {
			...
			for (var g = 0, h = b.length; g < h; g++)
				b[g].className && b[g].className.match(e) && f.push(b[g]);
	...
	(ParticleSlider.prototype.nextFrame = function () {
		var a = this;
		(a.mouseDownRegion == 1 && a.mx < a.cw / 2) || (a.mouseDownRegion == -1 && a.mx > a.cw / 2)
		...
		if (b.imgs.length > 0) {
			...
			if (b.showArrowControls == !0) {
				...
				for (var e = 0, f = g.length; e < f; e++)
					(g[e].color = function () {
						return b.mx > 0 && b.mx > b.cw - (b.arrowPadding * 2 + b.$nextCanv.width)
							? b.hoverColorArr
							: b.colorArr;
					}),
						c.push(g[e]);
